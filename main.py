...
from address_extractor.address import address_extraction
from address_extractor.data_classes import Address
...
def index():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            extracted_addresses = address_extraction(filepath)
